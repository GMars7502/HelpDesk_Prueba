        ...
        <div class="main-wrapper main-wrapper-1">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="{{ setActive('/slas') }}">
                            <a class="nav-link" href="{{ route('slas.index') }}">
                                ...
                                <span>Nivel Problema</span>
                            </a>
                        </li>
                        @endcan

                        @can('permissions.index')
                        <li class="menu-header">Configuracion</li>
                        ...
                        <li class="{{ setActive('/user-log') }}">
                            <a class="nav-link" href="{{ route('userlog.index') }}">
                                ...
                                <span>Registros de usuario</span>
                            </a>
                        </li>
                        @endcan
                    </ul>
            ...
            <footer class="main-footer">
                <div class="footer-left">
                    Copyright &copy; 2024 <div class="bullet"></div> HELPDESK SYSTEM <div class="bullet"></div> todos los derechos reservados
                </div>
